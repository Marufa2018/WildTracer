...
public class DownloadData_location extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private final String TITLE_KEY = "created_at";
    ...
    public Loader<String> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        return new LocationLoader(this, queryString);
    }
    ...
    public void onLoadFinished(@NonNull Loader<String> loader, String data) {
        ...
        try {
            ...
            JSONArray itemsArray = jsonObject.getJSONArray("locations");
            ...
            FileOutputStream fOut = openFileOutput("location.txt",Context.MODE_PRIVATE);
            ...
            while (i < itemsArray.length() &&
                ...
                try {
                    ...
                    authors = book.getString("created_at");
            ...
            if (title != null && authors != null) {
                ...
                mBookInput.setText("");
                String message = title + " " + authors + " " + id;
