...
public class DownloadData extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private final String TITLE_KEY = "scientific_name";
    ...
    public void onLoadFinished(@NonNull Loader<String> loader, String data) {
        ...
        try {
            ...
            JSONArray itemsArray = jsonObject.getJSONArray("animals");
            ...
            FileOutputStream fOut = openFileOutput("title.txt",Context.MODE_PRIVATE);
